...
const Page = () => {
  ...
  const { products, addToCart, decreaseQuantity, removeFromCart } =
    useCartStore();
      ...
      {products.length == 0 ? (
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="flex flex-col space-y-3 md:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:justify-between sm:items-center flex-1">
              <div className="flex flex-1">
                ...
                />
                <button
                  className={`px-4 py-2 border-[0.5px] border-gray-800 flex-2 rounded`}
          ...
          <div className="border-[0.5px] border-gray-800 p-4 flex-1">
            ...
            <button
              className=" py-2 text-center w-full bg-blue-600 rounded text-black flex justify-center items-center space-x-2"
